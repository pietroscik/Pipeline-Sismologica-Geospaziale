...
if b_mag is not None and b_gen is not None:
    ...
    if variazione > 5.0:
        ...
        print("   fluidi magmatici o gas in pressione che stanno sbriciolando la roccia.")
    elif variazione < -5.0:
        print("⚠️ RISPOSTA TETTONICA: Il b-value è crollato a maggio.")
        print("   Il sistema sta accumulando stress su asperità rigide (faglia sottomarina),")
        print("   aumentando la probabilità di un evento singolo molto più forte.")
    else:
        print("🔒 SISTEMA STABILE: La meccanica di fratturazione non è cambiata tra i due mesi.")
