...
print(f"   ↳ Media stazioni attivate: {fase_gennaio['Numero_Stazioni_Attivate'].mean():.2f}")
print("-" * 50)
...
print(f"   ↳ Media stazioni attivate: {fase_maggio['Numero_Stazioni_Attivate'].mean():.2f}")
print("-" * 50)

# Vediamo dove si concentrano i 55 eventi maggiori (Mainshocks a 20 stazioni)
mainshocks_gennaio = fase_gennaio[fase_gennaio['Numero_Stazioni_Attivate'] == 20].shape[0]
