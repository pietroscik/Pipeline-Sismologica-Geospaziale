...
top_15 = report_stazioni.sort_values(by="Conteggio_Rilevamenti", ascending=False).head(
    15
)
...
for idx, row in top_15.iterrows():
    ...
    print(
        f"Stazione: {row['station']:4s} | Rilevamenti: {row['Conteggio_Rilevamenti']:6,d} | {barra_visiva}"
    )
print("-" * 65)
print(
    "📌 Le stazioni con la barra più lunga indicano la massima sensibilità epicentrale."
)
