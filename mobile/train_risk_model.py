...
DEFAULT_INPUT = (
    PROJECT_ROOT / "examples" / "mobile_devices" / "scoperte_automatiche.csv.gz"
)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Train ML model for Campi Flegrei monitoring"
    )
    ...
    manager = ModelVersionManager(
        model_type=args.model_type, use_mlflow=not args.no_mlflow
    )
